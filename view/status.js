...
var background_button = document.querySelector("button[name='background_connect']");
...
//chrome.storage.local.get(['fpoc_server'], function(value) {
//    console.log('[DEBUG] algo leyo de chrome.storage',value.fpoc_server);
//    fpoc_server = value.fpoc_server;
//});
...
function set_state(_state) {
    ...
    switch (state) {
        ...
        case 'login':
            ...
            break;
        case 'online':
	    console.log('[DEBUG] set_state online', fpoc_server);
	    if (fpoc_server != {}) {
		console.log('[DEBUG] set_state_online fpoc_server',fpoc_server);
		console.log('[DEBUG] set_state_online fpoc_server.database',fpoc_server.database);
		console.log('[DEBUG] set_state_online fpoc_server.user',fpoc_server.user);
		console.log('[DEBUG] set_state_online fpoc_server.pwd',fpoc_server.pwd);
...
function update_view() {
    ...
    console.log('[DEBUG] pasando por update_view');
...
login_button.onclick = function(event) {
    console.log('[DEBUG] clickeo login_button');
    set_state('online');
};

background_button.onclick = function(event) {
    console.log('[DEBUG] clickeo background_connect_button');
    if (printer_table.rows.length == 0) {
	    console.log('[DEBUG] sin impresora');
	} else {
	    console.log('[DEBUG] con impresora');
	    set_state('online');
	};
};
...
var fpoc_server = JSON.parse(data);
fpoc_server = fpoc_server[0];
console.log('JSON ',fpoc_server.host);
console.log('JSON ',fpoc_server.database);
console.log('JSON ',fpoc_server.user);
console.log('JSON ',fpoc_server.pwd);
